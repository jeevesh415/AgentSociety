...
DEFAULT_MODEL_NAME = os.getenv("AGENT_GENERATOR_MODEL", "qwen3-next-80b-a3b-instruct")
...
class AgentGenerator:
    ...
    async def generate(
        ...
        *,
        ...
        logger.info(
            f"Generating {count} agents using code generation (based on {len(base_agents)} base agents)"
        )
        ...
        try:
            ...
            request = CodeGenerationRequest(description=prompt)

            logger.info(f"Generating code to create {count} agents...")
